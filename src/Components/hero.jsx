        ...
        <section className="bg-indigo-50 h-[650px] py-10 px-10 md:px-8">
          <div className='flex flex-row h-[600px]'>
            <div className="max-w-7xl mx-auto text-left py-60 text-gray-900">
              ...
              <a href="#practice" className="bg-violet-500 hover:bg-violet-600 text-white font-semibold hover:shadow-md py-3 px-6 rounded-full transition duration-300">Start Practicing</a>
            </div>
            <div className=' h-[612px] w-[612px] py-10 mx-10 pb-10'>
            <img src="" alt="" className='h-[512px] w-[512px]'/>
            </div>
          </div>
        </section>
      </div>
